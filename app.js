...
const els = {
  ...
  stationMovingButton: document.querySelector("#stationMovingButton"),
...
function render() {
  ...
  els.stationMovingButton.classList.toggle("is-active", Boolean(data.stationMoving));
  els.stationMovingButton.setAttribute("aria-pressed", String(Boolean(data.stationMoving)));
...
function toggleStationMoving() {
  data.stationMoving = !data.stationMoving;
  saveData();
  render();
}
...
els.stationMovingButton.addEventListener("click", toggleStationMoving);
